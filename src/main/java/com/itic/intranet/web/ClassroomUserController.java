...
public class ClassroomUserController {
    ...
    public ResponseEntity<List<UserMinimalDto>> getTeachersOfClassroom(@PathVariable Long classroomId) {
        List<UserMinimalDto> teachers = classroomUserService.getTeachersOfClassroom(classroomId);
    ...
    public ResponseEntity<List<UserMinimalDto>> getStudentsOfClassroom(@PathVariable Long classroomId) {
        List<UserMinimalDto> students = classroomUserService.getStudentsOfClassroom(classroomId);
